...
const About = () => {
    useEffect(() => {
        const initScripts = () => {
             // Re-init Team Slider
             if (window.Swiper && document.querySelector(".home3-team-slider")) {
                new window.Swiper(".home3-team-slider", {
                    loop: true,
                    spaceBetween: 30,
                    speed: 2000,
                    pagination: {
            ...
            // Re-init Testimonial Slider
            if (window.Swiper && document.querySelector(".home3-testimonial-slider")) {
                new window.Swiper(".home3-testimonial-slider", {
                    loop: true,
                    spaceBetween: 30,
                    speed: 2000,
                    centeredSlides: true,
        ...
        // Delay slightly to ensure DOM is rendered by React
                            ...
                            <div className="choose-feature">
                                <ul>
                                    ...
                                    <li>
                                        <div className="single-feature">
                                            <div className="progress">
                                                <h3><span className="counter">85</span>%</h3>
                                            </div>
                                            <div className="content">
                                                <h4>Keyword</h4>
                                                <p>Morbi interdum pellentesque nunc, luctuso pretium nullagoneq luctus at. Aliquam one cursus nunc arcu</p>
                ...
                <div className="col-xl-9 d-flex justify-content-end">
                    <div className="counter-area">
                        <div className="row g-lg-0 gy-5">
                            <div className="col-lg-3 col-sm-6 d-flex justify-content-center wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            ...
                            <div className="col-lg-3 col-sm-6 d-flex justify-content-center devider wow animate fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                                <div className="single-counter">
                                    <div className="icon">
                                        <svg width="50" height="57" viewBox="0 0 50 57" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="col-lg-3 col-sm-6 d-flex justify-content-center devider wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <div className="single-counter">
                                    <div className="icon">
                                        <svg width="50" height="57" viewBox="0 0 50 57" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="col-lg-3 col-sm-6 d-flex justify-content-center devider wow animate fadeInUp" data-wow-delay="500ms" data-wow-duration="1500ms">
                                <div className="single-counter">
                                    <div className="icon">
                                        <svg width="50" height="57" viewBox="0 0 50 57" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* End testimonial Section */}
      ...
      <div className="home3-team-area sec-mar">
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="swiper home3-team-slider">
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
