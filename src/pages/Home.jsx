...
const Home = () => {
                    ...
                    <div className="banner-wrapper">
                        <div className="banner-content">
                            ...
                            <div className="banner-btn-group">
                                ...
                                <Link className="primary-btn4" to="/about">
                                    <span>
                                        <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                        </svg>
                        ...
                        <div className="banner-video-area">
                            <div className="video-area">
                                <a data-fancybox="gallery" className="video-popup" href="https://www.youtube.com/watch?v=u31qwQUeGuM&ab_channel=JoomlaTemplate">
    ...
    <style>{`
        .home3-solution-slider {
            width: 100% !important;
            overflow: visible !important;
        }
        .home3-solution-slider .swiper-slide {
            width: 415px !important;
            margin-right: 30px !important;
        }
        .home3-solution-slider .swiper-wrapper {
        ...
        <div className="container">
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div style={{ maxWidth: "1310px", margin: "0 auto", overflow: "hidden" }}>
                        ...
                        <div className="swiper-wrapper">
                            ...
                            <div className="swiper-slide">
                                <div className="solution-card">
                                    ...
                                    <div className="solution-content">
                                        <h4><Link to="/service-details">Cloud Solutions</Link></h4>
                            ...
                            <div className="swiper-slide">
                                <div className="solution-card">
                                    ...
                                    <div className="solution-content">
                                        <h4><Link to="/service-details">Cyber Security</Link></h4>
                            ...
                            <div className="swiper-slide">
                                <div className="solution-card">
                                    ...
                                    <div className="solution-content">
                                        <h4><Link to="/service-details">Data Analytics</Link></h4>
...
{/* End Solution Section */}
    ...
    <div className="home3-success-stories-area sec-mar">
            ...
            <div className="row mb-60 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-4">
                    ...
                    <div className="view-all-btn">
                        <Link className="primary-btn3" to="/project-masonary">View All Project</Link>
                    </div>
                </div>
            </div>
        </div>
        <div className="container-fluid">
            <div className="row">
                <div className="col-lg-12">
                    <div style={{ maxWidth: "1350px", margin: "0 auto", overflow: "hidden" }}>
                        <div className="swiper home3-success-stories-slider" style={{ overflow: "visible" }}>
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
...
{/* End Succrss Srories Section */}
    ...
    <style>{`
        ...
        .home3-testimonial-slider .swiper-slide {
        ...
        .home3-testimonial-slider .swiper-slide-active {
            opacity: 1 !important;
            transform: scale(1);
        }
        .home3-testimonial-slider .swiper-wrapper {
            display: flex !important;
            width: auto !important;
            align-items: center;
        }
    ...
    <style>{`
        ...
        .testimonial-card3 {
            position: relative;
            background: #111; /* Dark background from reference */
            padding: 40px;
            border-radius: 20px;
        }
        .testimonial-card3 .quate-icon {
            position: absolute;
            top: 50%;
            left: 50%;
        ...
        .testimonial-card3 .testimonial-content,
        .testimonial-card3 .testimonial-top,
        .testimonial-card3 .testimonial-btm {
            position: relative;
            z-index: 1;
        }
        .author-img-wrapper {
            ...
            display: none; /* Only show for active slide */
        }
        .swiper-slide-active .author-img-wrapper {
            display: block;
        }
    `}</style>
            ...
            <div className="row mb-55">
                <div className="col-lg-12 d-flex align-items-center justify-content-between gap-4 flex-wrap">
                    <div className="section-title-3">
                        ...
                        <p>Services are professional offerings provided by businesses to meet specific needs.</p>
                    </div>
                    <div className="swiper-btn-group">
                        <div className="swiper-btn prevbtn2"><i className="bi bi-arrow-left"></i></div>
                        <div className="swiper-btn nextbtn2"><i className="bi bi-arrow-right"></i></div>
                    </div>
                </div>
            </div>    
            <div className="row">
                            ...
                            <div className="swiper-wrapper">
                                <div className="swiper-slide">
                                    <div className="testimonial-card3">
                                        ...
                                        <div className="testimonial-btm mt-4">
                                            <h4>Mateo Daniel</h4>
                                            <span style={{ color: "#00f1a1" }}>CEO AI atlantis.com</span>
                                ...
                                <div className="swiper-slide">
                                    <div className="testimonial-card3">
                                        ...
                                        <div className="testimonial-btm mt-4">
                                            <h4>Mateo Daniel</h4>
                                            <span style={{ color: "#00f1a1" }}>CEO At atlantis.com</span>
                                            <p style={{ fontSize: "12px", color: "#666" }}>May 9, 2023 | 10.30 PM</p>
                                        </div>
                                        <div className="author-img-wrapper">
                                            ...
                                            <ul>
                                                <li>
                                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <path
                                                            d="M6.34172 12.8L6.28743 12.6983C5.45809 11.1441 3.25425 7.84599 3.23199 7.81286L3.2002 7.76536L3.95103 6.94922L6.32778 8.77458C7.82424 6.63876 9.22034 5.17178 10.131 4.31512C11.1272 3.37803 12.7936 3.20415 12.8002 3.20001C9.6713 6.26525 6.42863 12.632 6.39485 12.6975L6.34172 12.8Z" />
                                                    </svg>
                        ...
                        <div className="experts-img">
                            ...
                            <div className="expert-social">
                                <ul>
                                    <li><a href="https://www.facebook.com/"><i className="bx bxl-facebook"></i></a></li>
                                    <li><a href="https://twitter.com/"><i className="bx bxl-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/"><i className="bx bxl-pinterest-alt"></i></a></li>
                                    <li><a href="https://www.pinterest.com/"><i className="bx bxl-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="single-blog magnetic-item">
                        ...
                        <div className="blog-content">
                            <ul className="blog-meta">
                                <li><Link to="/blog">May 20, 2023</Link></li>
                                <li><Link to="/blog">Comment (3)</Link></li>
                            </ul>
                            <h4><Link to="/blog-details">Donec finibus laoreet exte eu pellentesque. </Link></h4>
                            <div className="blog-footer">
                                <div className="read-btn">
                                    <Link to="/blog-details">Read More
                                        <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 1H12M12 1V13M12 1L0.5 12"></path>
                                        </svg>
                                    </Link>
                ...
                <div className="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div className="single-blog magnetic-item">
                        ...
                        <div className="blog-content">
                            ...
                            <h4><Link to="/blog-details">feugiat varius mattis mass enim est egestas.</Link></h4>
                            <div className="blog-footer">
                                <div className="read-btn">
                                    <Link to="/blog-details">Read More
                                        <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="single-blog magnetic-item">
                        ...
                        <div className="blog-content">
                           <ul className="blog-meta">
                            ...
                            <h4><Link to="/blog-details">Navigating the Journey off Cloud Solution.</Link></h4>
                            <div className="blog-footer">
                                <div className="read-btn">
                                    <Link to="/blog-details">Read More
                                        <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
