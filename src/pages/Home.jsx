        ...
        <>
            ...
            <div className="banner-area3">
                <div className="scroll-down">
                    <a href="index.html#home3-partner-area">
                        Scroll Down
                        <span>
                            ...
                            <div className="banner-wrapper">
                                <div className="banner-content">
                                    ...
                                    <div className="banner-btn-group">
                                        <a className="primary-btn3" to="/contact">Free Consultancy</a>
                                        <a className="primary-btn4" to="/about">
                                            <span>
                                                <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                                </svg>
                                ...
                                <div className="swiper-wrapper">
                                    ...
                                    <div className="swiper-slide">
                                        <div className="solution-card">
                                            ...
                                            <div className="solution-content">
                                                <h4><a href="service-details.html">Cloud Solutions</a></h4>
                    ...
                    <div className="row mb-60 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-4">
                            ...
                            <div className="view-all-btn">
                                <a className="primary-btn3" href="project.html">View All Project</a>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div className="pricing-card">
                                                ...
                                                <div className="pricing-content">
                                                    ...
                                                    <div className="pay-btn">
                                                        <a className="primary-btn3" to="/">Pay Now</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
