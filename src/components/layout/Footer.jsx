                    ...
                    <div className="col-lg-4 col-sm-6 d-flex">
                        <div className="footer-widget">
                            <div className="footer-contact mb-40">
                                ...
                                <Link to="/">House 168/170, Avenue 01, Mirpur DOHS, Dhaka Bangladesh</Link>
                            </div>
                            <div className="footer-contact mb-40">
                                <h4>
                                ...
                                <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#5b323d341b3e233a362b373e75383436"><span className="__cf_email__" data-cfemail="553c333a15302d34382539307b363a38">[email&#160;protected]</span></a><br />
                                <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#4920272f26093a3c3939263b3d672a2624"><span className="__cf_email__" data-cfemail="f39a9d959cb3808683839c8187dd909c9e">[email&#160;protected]</span></a>
                            </div>
                        ...
                        <div className="footer-widget">
                            ...
                            <div className="menu-container">
                                <ul>
                                    ...
                                    <li><Link to="/service">Mobile Development</Link></li>
                                    <li><Link to="/service">Cloud Services</Link></li>
                                    <li><Link to="/service">Network Connectivity</Link></li>
                                    <li><Link to="/service">Data analytics</Link></li>
                                    <li><Link to="/service">Software Development</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="footer-widget">
                            ...
                            <div className="menu-container">
                                <ul>
                                    ...
                                    <li><Link to="/blog">News & Article</Link></li>
                                    <li><Link to="/team">Our Team</Link></li>
                                    <li><Link to="/project">All Portfolio</Link></li>
                        ...
                        <div className="col-lg-12">
                            <div className="footer-btn-content">
                                <div className="copyright-area">
                                    <p>©Copyright 2023 <Link to="/">Softconic</Link> | Design By <a href="https://www.egenslab.com/">Egens Lab</a></p>
                                </div>
                                <div className="footer-social">
                                    <ul>
                                        ...
                                        <li><a href="https://www.linkedin.com/"><i className="bx bxl-pinterest-alt"></i></a></li>
