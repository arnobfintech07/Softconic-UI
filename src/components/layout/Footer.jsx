                    ...
                    <div className="col-lg-12">
                        <div className="footer-top-content">
                            <div className="footer-logo">
                                <a href="index.html"><img className="img-fluid" src="assets/img/logo.svg" alt="" /></a>
                            </div>
            ...
            <div className="row g-lg-4 gy-5">
                <div className="col-lg-4 col-sm-6 d-flex">
                    <div className="footer-widget">
                        <div className="footer-contact mb-40">
                            ...
                            <a href="index.html#">House 168/170, Avenue 01, Mirpur DOHS, Dhaka Bangladesh</a>
                        </div>
                        <div className="footer-contact mb-40">
                            <h4>
                ...
                <div className="col-lg-3 col-sm-6 d-flex justify-content-sm-end">
                    <div className="footer-widget">
                        ...
                        <div className="menu-container">
                            <ul>
                                <li><a href="index.html#">Support Area</a></li>
                    ...
                    <div className="col-lg-12">
                        <div className="footer-btn-content">
                            <div className="copyright-area">
                                <p>©Copyright 2023 <a href="index.html#">Softconic</a> | Design By <a href="https://www.egenslab.com/">Egens Lab</a></p>
                            </div>
